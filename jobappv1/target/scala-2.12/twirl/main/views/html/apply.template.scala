...
<body>
  ...
  """),_display_(/*78.4*/helper/*78.10*/.form(action = routes.JobController.applyToJob(index), 'enctype -> "multipart/form-data")/*78.99*/{_display_(Seq[Any](format.raw/*78.100*/("""
    """),_display_(/*79.6*/helper/*79.12*/.CSRF.formField),format.raw/*79.27*/("""
    """),format.raw/*80.5*/("""<p>Please upload your resume</p>
    """),_display_(/*81.6*/helper/*81.12*/.inputFile(applyForm("resume"))),format.raw/*81.43*/("""
    """),format.raw/*82.5*/("""<button type="submit">Apply</button>
  """)))}),format.raw/*83.4*/("""
